...
Runner.prototype = {
  ...
  if (this.playing) {
    ...
    if (collision.collision) {
      if (collision.type === 'PTERODACTYL') {
        // Collect pterodactyl
        this.distanceRan += 50; // Add 50 to score
        this.playSound(this.soundFx.SCORE);
        // Remove the pterodactyl
        this.horizon.removeFirstObstacle();
      } else {
        // Game over for other obstacles
        this.gameOver();
      }
    }

    // Update distance and speed
    if (!collision.collision || collision.type === 'PTERODACTYL') {
